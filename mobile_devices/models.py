...
class Device(models.Model):
    ...
    category = models.ForeignKey(
        Category, on_delete=models.CASCADE, related_name="devices", null=True
    )
...
class Review_device(models.Model):
    review_devices = models.ForeignKey(
        Device, on_delete=models.CASCADE, related_name="review_devices"
    )
